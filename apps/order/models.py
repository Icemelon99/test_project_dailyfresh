...
class OrderInfo(BaseModel):
    ...
    order_id = models.CharField(max_length=128, primary_key=True, verbose_name='订单id') # 订单编号与表主键id不同
    ...
    trade_no = models.CharField(max_length=128, verbose_name='支付编号') # 支付编号为支付宝等提供
